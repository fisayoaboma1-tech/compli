...
export function Contact() {
  return (
    <section className="relative overflow-hidden py-0 sm:py-20" style={{ background: "#050d0a" }}>
      <video
        autoPlay
        loop
        muted
      ...
      <div className="absolute inset-0 bg-[#050d0a]/60 pointer-events-none" />
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-5 py-20 sm:py-28 text-center">
        <ScrollReveal>
          ...
          <p className="mt-4 text-white/80 max-w-xl mx-auto" style={{ textWrap: "pretty" }}>
            Reach out to PT. Solusi Sertifikasi Nasional Indonesia and get your products certified against all national standards.
          </p>
