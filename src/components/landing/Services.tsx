            ...
            <div className="grid sm:grid-cols-2 gap-5">
              {services.map((s, i) => (
                <ScrollReveal key={s.title} delay={i * 70}>
                  <div className="group relative rounded-2xl border border-black/[0.04] bg-black/[0.03] p-5 hover:bg-black/[0.05] hover:border-black/[0.08] transition-all duration-300 overflow-hidden">
                    <div className="absolute inset-0 pointer-events-none" style={{ backgroundImage: `url(${shadowBg})`, backgroundSize: 'cover', backgroundPosition: 'center', opacity: 0.15 }} />
